...
export default function Dropdowndemo() {
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await requester.post('/deals', formField);
  ...
  return (
    <form onSubmit={onSubmit} style={{ width: '1100px', margin: '20px auto' }}>
      <div className="grid grid-rows-2 grid-flow-col gap-5 grid-cols-2">
